...
register_patterns = [
    ...
    path('logout/', auth_views.UserLogoutView.as_view(), name='auth_logout'),
    ...
    path('2fa/', totp.TOTPLoginView.as_view(), name='login_2fa'),
    path('2fa/enable/', totp.TOTPEnableView.as_view(), name='enable_2fa'),
    path('2fa/disable/', totp.TOTPDisableView.as_view(), name='disable_2fa'),
]
...
urlpatterns = [
    ...
    path('problem/<str:problem>/', include([
        ...
        path('pdf/<str:language>/', problem.ProblemPdfView.as_view(), name='problem_pdf'),
        path('clone/', problem.ProblemClone.as_view(), name='problem_clone'),
        path('submit/', problem.problem_submit, name='problem_submit'),
        path('resubmit/<int:submission>/', problem.problem_submit, name='problem_submit'),
    ...
    path('submission/<int:submission>/', include([
        ...
        path('html/', submission.single_submission),
    ])),
    ...
    path('widgets/', include([
        ...
        path('single_submission/', submission.single_submission_query, name='submission_single_query'),
...
for favicon in favicon_paths:
    urlpatterns.append(re_path('%s' % favicon, RedirectView.as_view(
