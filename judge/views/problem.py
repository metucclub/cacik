...
def problem_submit(request, problem=None, submission=None):
            ...
            with transaction.atomic():
                if profile.current_contest is not None:
                    ...
                    try:
                        ...
                        if max_subs and get_contest_submission_count(problem, profile, profile.current_contest.virtual) >= max_subs:
    ...
    if profile.current_contest is not None:
        try:
            ...
            if submission_limit:
                submissions_left = submission_limit - get_contest_submission_count(problem, profile, profile.current_contest.virtual)
