# Generated by Django 2.1.13 on 2019-10-20 14:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freeze_scoreboard_after', models.DateTimeField(blank=True, help_text='Freeze scoreboard after this time.', null=True, verbose_name='freeze scoreboard after')),
                ('use_clarifications', models.BooleanField(default=True, help_text='Use clarification system instead of comments.', verbose_name='use clarification system')),
                ('no_social_share', models.BooleanField(default=False, help_text='Disable social share buttons on contest page', verbose_name='disable social share buttons')),
                ('hide_points', models.BooleanField(default=False, help_text='Hide points on all pages', verbose_name='hide points')),
                ('hide_participation_tab', models.BooleanField(default=False, help_text='Hide participation tab on contest page', verbose_name='hide participation tab')),
            ...
            options={
                ...
                'permissions': (('see_private_contest', 'See private contests'), ('edit_own_contest', 'Edit own contests'), ('edit_all_contest', 'Edit all contests'), ('clone_contest', 'Clone contest'), ('contest_rating', 'Rate contests'), ('contest_access_code', 'Contest access codes'), ('create_private_contest', 'Create private contests')),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frozen_score', models.IntegerField(db_index=True, default=0, verbose_name='frozen score')),
                ('frozen_cumtime', models.PositiveIntegerField(default=0, verbose_name='frozen cumulative time')),
                ('frozen_format_data', jsonfield.fields.JSONField(blank=True, null=True, verbose_name='frozen contest format specific data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_limit', models.FloatField(help_text='The time limit for this problem, in seconds. Fractional seconds (e.g. 1.5) are supported.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(2000)], verbose_name='time limit')),
                ('memory_limit', models.PositiveIntegerField(help_text='The memory limit for this problem, in kilobytes (e.g. 64mb = 65536 kilobytes).', verbose_name='memory limit')),
                ('short_circuit', models.BooleanField(default=False)),
                ('points', models.FloatField(help_text="Points awarded for problem completion. Points are displayed with a 'p' suffix if partial.", verbose_name='points')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_contest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='judge.Contest')),
            ],
